...
public class PlantService {
    ...
    //farm
    public void update(Integer farmId ,Integer guidanceId,Plant plant) {
        Plant plant1 = plantRepository.findPlantById(guidanceId);
        if (plant1 == null) {
    ...
    //farm
    public void deletePlant(Integer farmId , Integer guidanceId) {
        Plant plant1 = plantRepository.findPlantById(guidanceId);
        if (plant1 == null) {
            throw new ApiException("Plant not found");
        }
